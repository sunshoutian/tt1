<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <q-dialog v-model="layout" ref="dialog" @show="shown" @hide="hidden">
      <q-layout view="Lhh lpR fff" container :class="$q.dark.isActive ? 'bg-grey-9' :'bg-white'">
        ...
        <q-drawer bordered v-model="drawer" :width="200" :breakpoint="600" content-class="q-pa-sm">
