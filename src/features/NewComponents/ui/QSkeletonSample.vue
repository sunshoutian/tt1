<template>
  <q-page padding>
    <!-- <dynamic-skeleton :rows="5" :cols="4"/> -->
    <div class="q-pa-md q-gutter-md row justify-center">
      <div>
        <q-btn color="primary" @click="showTextLoading" :loading="visible">Show Skeleton Loader</q-btn>
      </div>
          ...
          <template v-slot:append>
            ...
            >
              <q-menu transition-show="flip-right" transition-hide="flip-left">
                <q-color :color="skeletonColor.primary" v-model="skeletonColor.primary"/>
              </q-menu>
            </q-btn>
          </template>
        </q-field>
      ...
      <div class="col-12 row justify-center">
        <q-card class="relative-position card-example">
          <q-card-section>
            <div class="text-h6" v-if="showSimulatedReturnData">Lorem Ipsum</div>
          </q-card-section>
...
<script>
import DynamicSkeleton from './DynamicQSkeleton.vue'
export default {
  components: { DynamicSkeleton },
  data() {
    return {
      visible: false,
